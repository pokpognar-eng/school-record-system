...
export default function App() {
  ...
  @media print {
    ...
    * {
    ...
    body {
      font-size: 16pt !important; /* 16pt = มาตรฐานราชการ */
    ...
    th {
      ...
      height: 10mm !important; /* ความสูงคงที่ */
    }
    ...
    td {
      ...
      vertical-align: middle !important;
      font-size: 14pt !important;
      height: 8mm !important; /* ความสูงคงที่ */
    }
    ...
    td[data-empty="true"] {
      border: 1pt solid #000000 !important;
      height: 8mm !important; /* ความสูงเท่ากับช่องอื่น */
    }
      ...
      `}>
        ...
        <div className="mt-auto p-4 border-t bg-gray-50/50">
          ...
          <div className="mt-4 text-[10px] text-center text-gray-400 flex items-center justify-center gap-1">
             v9.4 (Fixed Scroll/Margins/Signatures) • {ENABLE_SHARED_DATA ? <Cloud size={10} className="text-blue-500" /> : <CloudOff size={10} />}
          </div>
        </div>
      </aside>
...
const ReportView = ({ user, setPermissionError }) => {
  ...
  return (
    <div className="h-full flex flex-col relative bg-slate-200/50 print:bg-white">
      ...
      <div className="flex-1 flex flex-col items-center py-8 px-4 w-full" id="print-root">
         ...
         <div className="print-page-portrait relative text-black bg-white">
             ...
             {/* Signatures with Dotted Lines (3-3-2 Layout) */}
             <div className="signature-section" style={{marginTop: '25pt'}}>
                 {/* Row 1 (3 persons) */}
                 <div className="signature-grid" style={{marginBottom: '20pt', display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10pt'}}>
                     <div className="signature-block"><div>ลงชื่อ ........................................</div><div>(นายฐิติกานต์ พรมโสภา)</div><div style={{fontSize: '11pt'}}>หัวหน้าห้องบุคคลที่มีความบกพร่องทางร่างกาย</div></div>
                     <div className="signature-block"><div>ลงชื่อ ........................................</div><div>(นายณรงค์ฤทธิ์ ปกป้อง)</div><div style={{fontSize: '11pt'}}>ครูผู้สอน</div></div>
                     <div className="signature-block"><div>ลงชื่อ ........................................</div><div>(นางสาวจุฬาลักษณ์ จุฬารมย์)</div><div style={{fontSize: '11pt'}}>หัวหน้าห้องกายภาพบำบัด</div></div>
                 </div>

                 {/* Row 2 (3 persons) */}
                 <div className="signature-grid" style={{marginBottom: '20pt', display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '10pt'}}>
                     <div className="signature-block"><div>ลงชื่อ ........................................</div><div>(นายฐกฤต มิ่งขวัญ)</div><div style={{fontSize: '11pt'}}>ครูผู้สอน</div></div>
                     <div className="signature-block"><div>ลงชื่อ ........................................</div><div>(นายพโนมล ชมโฉม)</div><div style={{fontSize: '11pt'}}>ครูผู้สอน</div></div>
                     <div className="signature-block"><div>ลงชื่อ ........................................</div><div>(นายยุทธชัย แก้วพิลา)</div><div style={{fontSize: '11pt'}}>หัวหน้ากลุ่มบริหารวิชาการ</div></div>
                 </div>

                 {/* Row 3 (2 persons centered) */}
                 <div style={{display: 'flex', justifyContent: 'center', gap: '80px', marginTop: '20pt'}}>
                     <div className="signature-block" style={{width: '40%', textAlign: 'center'}}><div>ลงชื่อ ........................................</div><div>(นายอานนท์ สีดาพรม)</div><div style={{fontSize: '11pt'}}>รองผู้อำนวยการศูนย์การศึกษาพิเศษ ประจำจังหวัดยโสธร</div></div>
                     <div className="signature-block" style={{width: '40%', textAlign: 'center'}}><div>ลงชื่อ ........................................</div><div>(นายกำพล พาภักดี)</div><div style={{fontSize: '11pt'}}>ผู้อำนวยการศูนย์การศึกษาพิเศษ ประจำจังหวัดยโสธร</div></div>
                 </div>
             </div>
         ...
         {/* Page 2 Landscape (Detailed Data - Original Horizontal Layout) */}
